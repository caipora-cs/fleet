...
base_factory_contract = web3.eth.contract(
    address=base_factory_address, abi=base_factory_contract_abi
)
...
while True:
    ...
    new_pairs = base_factory_contract.events.PairCreated.get_logs(
